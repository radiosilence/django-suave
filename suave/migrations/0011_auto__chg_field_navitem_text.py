...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NavItem.text'
        db.alter_column('suave_navitem', 'text', self.gf('django.db.models.fields.CharField')(max_length=127, null=True))

    def backwards(self, orm):

        # Changing field 'NavItem.text'
        db.alter_column('suave_navitem', 'text', self.gf('django.db.models.fields.CharField')(default='', max_length=127))
