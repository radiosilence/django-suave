...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Page', fields ['status']
        db.create_index('suave_page', ['status'])

        # Adding index on 'Attachment', fields ['status']
        db.create_index('suave_attachment', ['status'])

        # Adding index on 'Carousel', fields ['status']
        db.create_index('suave_carousel', ['status'])

        # Adding index on 'Nav', fields ['status']
        db.create_index('suave_nav', ['status'])

    def backwards(self, orm):
        # Removing index on 'Nav', fields ['status']
        db.delete_index('suave_nav', ['status'])

        # Removing index on 'Carousel', fields ['status']
        db.delete_index('suave_carousel', ['status'])

        # Removing index on 'Attachment', fields ['status']
        db.delete_index('suave_attachment', ['status'])

        # Removing index on 'Page', fields ['status']
        db.delete_index('suave_page', ['status'])
