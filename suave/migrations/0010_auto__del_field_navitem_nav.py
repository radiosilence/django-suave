...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('suave_navitem', 'nav_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'NavItem.nav'
        raise RuntimeError("Cannot reverse this migration. 'NavItem.nav' and its values cannot be restored.")
