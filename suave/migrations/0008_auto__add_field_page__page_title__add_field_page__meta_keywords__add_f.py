...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('suave_page', '_page_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page._meta_keywords'
        db.add_column('suave_page', '_meta_keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page._meta_description'
        db.add_column('suave_page', '_meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Page._page_title'
        db.delete_column('suave_page', '_page_title')

        # Deleting field 'Page._meta_keywords'
        db.delete_column('suave_page', '_meta_keywords')

        # Deleting field 'Page._meta_description'
        db.delete_column('suave_page', '_meta_description')
