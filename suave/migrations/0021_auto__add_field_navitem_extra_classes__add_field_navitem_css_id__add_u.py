...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NavItem.extra_classes'
        db.add_column('suave_navitem', 'extra_classes',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NavItem.css_id'
        db.add_column('suave_navitem', 'css_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'ContentBlock', fields ['identifier']
        db.create_unique('suave_contentblock', ['identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContentBlock', fields ['identifier']
        db.delete_unique('suave_contentblock', ['identifier'])

        # Deleting field 'NavItem.extra_classes'
        db.delete_column('suave_navitem', 'extra_classes')

        # Deleting field 'NavItem.css_id'
        db.delete_column('suave_navitem', 'css_id')
