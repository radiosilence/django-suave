...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('suave_page', 'order')

        # Deleting field 'Nav.order'
        db.delete_column('suave_nav', 'order')

        # Deleting field 'PageContent.order'
        db.delete_column('suave_pagecontent', 'order')

        # Deleting field 'Attachment.order'
        db.delete_column('suave_attachment', 'order')

        # Deleting field 'ImageCarousel.order'
        db.delete_column('suave_imagecarousel', 'order')


    def backwards(self, orm):
        # Adding field 'Page.order'
        db.add_column('suave_page', 'order',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Nav.order'
        db.add_column('suave_nav', 'order',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'PageContent.order'
        db.add_column('suave_pagecontent', 'order',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Attachment.order'
        db.add_column('suave_attachment', 'order',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'ImageCarousel.order'
        db.add_column('suave_imagecarousel', 'order',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)
