...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('suave_redirect', (
            ...
            ('new_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('code', self.gf('django.db.models.fields.CharField')(default=302, max_length=3)),
        ))
    ...
    models = {
        ...
        'suave.redirect': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'code': ('django.db.models.fields.CharField', [], {'default': '302', 'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
