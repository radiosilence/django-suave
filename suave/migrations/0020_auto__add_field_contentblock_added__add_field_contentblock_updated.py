...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'ContentBlock.added'
        db.delete_column('suave_contentblock', 'added')

        # Deleting field 'ContentBlock.updated'
        db.delete_column('suave_contentblock', 'updated')
